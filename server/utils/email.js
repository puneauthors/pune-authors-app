...
<body>
  <div class="wrap">
    <div class="header"><h1>Pune Authors' Association</h1><p><a href="https://puneauthorsassociation.com/" style="color: #6366f1; text-decoration: none;">puneauthorsassociation.com</a></p></div>
    <div class="body">
      <h2>${heading}</h2>
      ${content}
      ${ctaButton}
