                    ...
                    >
                      ...
                      <div className="flex items-center justify-center gap-1.5 mt-auto w-full">
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="w-6 h-6 sm:w-7 sm:h-7 rounded-md bg-[#FFCC00]/20 hover:bg-[#FFCC00] text-[#FFCC00] hover:text-black flex items-center justify-center transition-all duration-200 hover:scale-110 shadow-sm border border-[#FFCC00]/30 hover:border-transparent cursor-pointer"
